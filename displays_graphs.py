...
from data_analysis_for_training import dict_buy, dict_no_buy, custom_but
...
df_buy['label'] = df_buy['count'].apply(lambda x: get_numerator(x, custom_but))
df_no_buy['label'] = df_no_buy['count'].apply(lambda x: get_numerator(x, custom_but))
